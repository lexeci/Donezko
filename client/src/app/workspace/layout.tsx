...
import {NoConnection, Sidebar} from "@/components/index";
...
export default function Layout({
    ...
    return isOnline ? (
        <div
            className="relative overflow-hidden max-h-[calc(100vh-82px)] w-full flex flex-row justify-between items-start">
            <Sidebar/>
            <div
                className={clsx(
            ...
            >
                {isLoading ? (
                    ...
                    <div
                        className="h-full flex flex-col justify-center items-center gap-y-4 max-w-[40rem] mx-auto text-center">
