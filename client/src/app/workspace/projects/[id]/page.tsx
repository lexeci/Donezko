...
export default function Project() {
    ...
    return project ? projectStatus === AccessStatus.ACTIVE ? (
        <PageLayout>
            <PageHeader
                pageTitle="Project"
            ...
            <div className={pageStyles["workspace-content-col"]}>
                {hasPermission && (
                    <div className="action-block flex flex-col gap-y-0.5 w-full border-4 border-foreground">
                        ...
                        <div
                            className="container border-t border-foreground flex flex-row justify-start items-center w-full p-2 gap-x-4">
                            <Button
                                block
                                negative
                                type="button"
                ...
                {openModal && (
                    ...
                    >
                        <div
                            className="container bg-background flex flex-col justify-center items-center p-4 gap-y-8 w-auto h-auto">
                            <div
                                className="desc max-w-80 flex flex-col justify-center items-center text-center gap-y-2">
