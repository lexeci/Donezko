    ...
    useEffect(() => {
        if (fetchedData) {
            ...
            if (usersArray && profileData) {
                const member = usersArray.filter((user) =>
                    user.userid === profileData.user.id && user
                )
    ...
    return fetchedData ? isMember ? (
        <PageLayout>
            ...
            {openModal && organizationId && (
                ...
                >
                    <div
                        className={pageStyles["workspace-modal-container"]}>
                        ...
                        <div className={pageStyles["workspace-modal-container__btn-container"]}>
                            ...
                            >
                                <Trash size={22} className={pageStyles["workspace-modal-container__ico"]}/> Delete
                            </Button>
                        </div>
                    </div>
                </ModalWindow>
