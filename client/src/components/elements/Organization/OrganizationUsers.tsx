            ...
            <div className={pageStyles["workspace-user-list__users"]}>
                {organizationUsers.length > 0 ? (
                    organizationUsers.map((userItem, i) => (
                        ...
                        >
                            <Person size={48} className={pageStyles["workspace-user-list__users__item__ico"]}/>
                            <div className={pageStyles["workspace-user-list__users__item__about"]}>
                                ...
                                <div className={pageStyles["workspace-user-list__users__item__status"]}>
                                    <p>Status: "{userItem.organizationStatus}"</p>
                                </div>
                                <div className={pageStyles["workspace-user-list__users__item__role"]}>
                                    <p>Role: "{userItem.role}"</p>
                                </div>
                                <div className={pageStyles["workspace-user-list__users__item__tasks"]}>
            ...
            {openModal && (
                ...
                >
                    <div className={pageStyles["workspace-modal-container"]}>
                        ...
                        <div className={pageStyles["workspace-modal-container__btn-container"]}>
                            <Button type="button" onClick={() => transferOwner()}>
                                <UserSwitch size={22}
                                            className={pageStyles["workspace-modal-container__ico"]}/> Transfer
                            </Button>
                        </div>
                    </div>
                </ModalWindow>
