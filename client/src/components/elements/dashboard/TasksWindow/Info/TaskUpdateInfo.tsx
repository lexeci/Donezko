    ...
    return (
        <div className="flex flex-col justify-start items-start w-full gap-y-4">
            ...
            <div className="text-block flex flex-col justify-start items-start w-full gap-y-4">
                ...
                <p>3. Update the <strong>"Description"</strong> field if additional details or changes are needed (optional, max 500 characters).</p>
                ...
                <p>7. If a new team is selected, assign a new <strong>performer</strong> from the list of team members (optional).</p>
            ...
            <div className="note text-xs border border-foreground p-2">
                <p>
                    Note: Any fields left unchanged will retain their previous values. Ensure you have the necessary permissions to modify tasks.
                </p>
            </div>
        </div>
    );
